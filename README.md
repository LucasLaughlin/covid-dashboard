...
2) From the command line: git clone https://github.com/LucasLaughlin/covid-dashboard.git

When you have new code to push to github repository:
1) go to root of github project
2) git add .
3) git commit -m "some message about your commit(i.e.: Finished pulling data)"
4) git push
